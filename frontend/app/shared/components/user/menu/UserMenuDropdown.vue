...
import type { IMenuItemConfig, IMenuSectionConfig } from '@infrastructure/config/userMenuConfig'
import { BASE_MENU_SECTIONS, ADMIN_MENU_SECTION } from '@infrastructure/config/userMenuConfig'
import UserInfo from '@shared/components/user/profile/UserInfo.vue'
import UserQuickStats from '@shared/components/user/profile/UserQuickStats.vue'
