...
import NavigationItem from "~/layouts/components/sidebar/menubar/components/NavigationItem.vue";
import NavigationGroup from "~/layouts/components/sidebar/menubar/components/NavigationGroup.vue";
