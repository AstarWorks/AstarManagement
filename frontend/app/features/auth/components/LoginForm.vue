...
import AuthFormHeader from '@auth/components/AuthFormHeader.vue'
import AuthFormFooter from '@auth/components/AuthFormFooter.vue'
import DevelopmentDebugPanel from '@auth/components/DevelopmentDebugPanel.vue'
