...
import SortIndicator from '@ui/data-table/SortIndicator.vue'
...
export const createExpenseColumns = (
  t: (key: string) => string,
  formatters: ReturnType<typeof import('@expense/composables/shared/useExpenseFormatters')['useExpenseFormatters']>,
  actions: {
