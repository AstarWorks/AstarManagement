<template>
  <span
    class="case-tag inline-flex items-center font-medium rounded-md bg-secondary text-secondary-foreground border border-border"
    :class="sizeClasses"
  >
    {{ tag }}
  </span>
...
// Color classes not currently used but available for future enhancement
