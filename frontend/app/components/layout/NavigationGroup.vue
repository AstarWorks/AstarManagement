<template>
  <div class="navigation-group">
    ...
    <button
      v-if="!collapsed"
      class="group-header w-full flex items-center px-3 py-2 text-left text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent rounded-lg transition-colors duration-200 group-header-spacing"
