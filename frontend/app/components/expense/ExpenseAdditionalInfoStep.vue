<template>
  <div class="expense-additional-info-step space-y-6">
    ...
    <div class="space-y-6">
      ...
      <!-- TODO: Implement attachment upload functionality in Sprint S03_M003 -->
    ...
    <!-- Form Summary -->
    <ExpenseAdditionalInfoSummary />
  </div>
</template>

<script setup lang="ts">
// Components
import ExpenseCaseSelector from './form/ExpenseCaseSelector.vue'
import ExpenseTagSelector from './form/ExpenseTagSelector.vue'
import ExpenseMemoInput from './form/ExpenseMemoInput.vue'
import ExpenseAdditionalInfoSummary from './form/ExpenseAdditionalInfoSummary.vue'
