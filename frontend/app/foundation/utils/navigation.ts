...
import type { NavigationItemConfig as INavigationItemConfig } from '~/foundation/config/navigationConfig'
import type { INavigationItem, IBreadcrumbItem } from '~/foundation/types/navigation'
