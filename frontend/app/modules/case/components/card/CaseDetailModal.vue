...
// Define actions directly instead of using composable for now
const handleClose = () => emit('close')
const handleEdit = (caseId: string) => emit('edit', caseId)
const handleStatusChange = (caseId: string) => emit('statusChanged', caseId, 'updated' as CaseStatus)
