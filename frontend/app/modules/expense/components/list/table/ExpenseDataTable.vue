...
import type { IExpense, IExpenseFilters } from '~/modules/expense/types'
import { computed, ref, watch } from 'vue'
import DataTable from '../../../../../foundation/components/ui/data-table/DataTable.vue'
import ColumnVisibilityDropdown from '~/foundation/components/ui/data-table/ColumnVisibilityDropdown.vue'
...
// Table reference with simplified interface
interface TableInstance {
  table: {
    ...
    // Add other properties as needed to satisfy the full Table interface
    [key: string]: unknown
  }
}
