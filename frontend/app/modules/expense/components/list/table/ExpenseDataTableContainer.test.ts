...
import type { IExpenseWithBalance, IExpenseCase } from '~/modules/expense/types'
...
vi.mock('~/modules/expense/composables/shared/useExpenseFormatters', () => ({
...
describe('ExpenseDataTableContainer', () => {
  ...
  describe('Selection functionality', () => {
    it('should emit selectionChange when selection changes', async () => {
      ...
      const { useTableSelection } = await import('~/foundation/composables/table/useTableSelection')
  ...
  describe('Sorting functionality', () => {
    it('should emit sortChange when sort is triggered', async () => {
      ...
      const { useTableSorting } = await import('~/foundation/composables/table/useTableSorting')
