...
import SortIndicator from '~/foundation/components/ui/data-table/SortIndicator.vue'
...
export const createExpenseColumns = (
  t: (key: string) => string,
  formatters: ReturnType<typeof import('~/modules/expense/composables/shared/useExpenseFormatters')['useExpenseFormatters']>,
  actions: {
