...
export function useMatterUpdateMutation() {
  ...
  return useMutation({
    mutationFn: async (params: { id: string; updates: Partial<Matter> }) => {
      const data = await $fetch<Matter>(`/api/matters/${params.id}`, {
        method: 'PATCH',
        body: params.updates,
      })
      return data
...
export function useBulkMoveMutation() {
  ...
  return useMutation({
    mutationFn: async (params: {
      ...
      const data = await $fetch<Matter[]>('/api/matters/batch-move', {
        method: 'PATCH',
        body: params,
      })
      return data
...
export function useMatterStatusChangeMutation() {
  ...
  return useMutation({
    mutationFn: async (params: {
      ...
      const data = await $fetch<Matter>(`/api/matters/${params.matterId}/status`, {
        method: 'PATCH',
        body: {
