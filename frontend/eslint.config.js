...
export default createConfigForNuxt({
    ...
    .append(// Prettier config to disable conflicting ESLint rules
        prettierConfig, // Vue.js specific rules
        {
            files: ['**/*.vue'], rules: {
                ...
                'vue/html-self-closing': ['error', {
                    'html': {
                        'void': 'always', 'normal': 'always', 'component': 'always',
        ...
        {
            files: ['**/*.stories.@(js|jsx|ts|tsx)'], plugins: {
        ...
        {
            files: ['**/*.test.@(js|ts)', '**/*.spec.@(js|ts)', '**/test/**/*', '**/tests/**/*'], rules: {
        ...
        }, // Legal domain specific rules
        {
            files: ['**/*'], rules: {
                ...
                'prefer-promise-reject-errors': 'error', 'no-throw-literal': 'error',
                ...
                // Code organization
                'prefer-const': 'error', 'no-var': 'error', 'object-shorthand': 'error',

                // Prevent common mistakes in legal domain
                'no-duplicate-case': 'error', 'no-fallthrough': 'error', 'default-case': 'error',
            },
        },
