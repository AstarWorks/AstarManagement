...
class TestDataController(
    ...
    fun createDefaultTestTenant(): TenantResponse {
        ...
        if (existingTenant != null) {
            ...
            return TenantResponse.from(existingTenant)
        }
    ...
    fun listTestTenants(): List<TenantResponse> {
        logger.info("Listing all test tenants")
        
        val tenants = tenantService.findAll()
        return tenants.map { TenantResponse.from(it) }
    }
    ...
    fun deleteTestTenant(
        ...
        return try {
            tenantService.deleteById(TenantId(id))
            Unit
        } catch (e: Exception) {
    ...
    fun deleteAllTestTenants(): Map<String, Any> {
    ...
    fun resetTestData(): Map<String, Any> {
    ...
    fun getTestDataStatus(): Map<String, Any> {
        val tenants = tenantService.findAll()
