...
class MockAuthService(
    ...
    fun generateToken(): String {
        return generateToken(listOf("ADMIN", "USER"))
    }
    
    /**
     * Generate a mock JWT token with specified roles.
     */
    fun generateToken(roles: List<String>): String {
        ...
        val claimsSet = JWTClaimsSet.Builder()
            ...
            // Add Auth0-style custom claims for testing JWT Claims Extraction
            .claim("org_id", "test-tenant-123")
            .claim("https://your-app.com/roles", roles)
            .claim("https://your-app.com/tenant_id", "custom-tenant-456")
            .build()
