...
export default defineNuxtConfig({
  ...
  plugins: [
    // Explicitly order plugins to ensure Vue Query loads before background sync
    { src: '~/plugins/tanstack-query.client.ts', mode: 'client' },
    // Disable vue-query.client.ts as it conflicts with tanstack-query.client.ts
    // { src: '~/plugins/vue-query.client.ts', mode: 'client' },
    { src: '~/plugins/z-background-sync.client.ts', mode: 'client' }
  ]
})
