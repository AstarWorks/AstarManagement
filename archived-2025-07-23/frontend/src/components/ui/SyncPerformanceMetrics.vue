...
// TODO: Tabs components need to be implemented
...
<template>
  <Card class="w-full">
    ...
    <CardContent>
      <!-- Temporary tabs implementation until tabs component is available -->
      <div class="w-full">
        <div class="grid grid-cols-4 w-full border-b">
          <button 
            @click="activeTab = 'overview'"
            :class="['px-4 py-2 text-sm font-medium transition-colors', activeTab === 'overview' ? 'border-b-2 border-primary text-primary' : 'text-muted-foreground hover:text-foreground']"
          >
            Overview
          </button>
          <button 
            @click="activeTab = 'network'"
            :class="['px-4 py-2 text-sm font-medium transition-colors', activeTab === 'network' ? 'border-b-2 border-primary text-primary' : 'text-muted-foreground hover:text-foreground']"
          >
            Network
          </button>
          <button 
            @click="activeTab = 'performance'"
            :class="['px-4 py-2 text-sm font-medium transition-colors', activeTab === 'performance' ? 'border-b-2 border-primary text-primary' : 'text-muted-foreground hover:text-foreground']"
          >
            Performance
          </button>
          <button 
            @click="activeTab = 'resources'"
            :class="['px-4 py-2 text-sm font-medium transition-colors', activeTab === 'resources' ? 'border-b-2 border-primary text-primary' : 'text-muted-foreground hover:text-foreground']"
          >
            Resources
          </button>
        </div>
        ...
        <!-- Overview Tab -->
        <div v-if="activeTab === 'overview'" class="space-y-4 mt-4">
        ...
        <!-- Network Tab -->
        <div v-if="activeTab === 'network'" class="space-y-4 mt-4">
        ...
        <!-- Performance Tab -->
        <div v-if="activeTab === 'performance'" class="space-y-4 mt-4">
        ...
        <!-- Resources Tab -->
        <div v-if="activeTab === 'resources'" class="space-y-4 mt-4">
