...
const opposingParties = ref<OpposingParty[]>([])
...
const existingClientOptions: Array<{ value: string; label: string }> = []
const lawyerOptions: Array<{ value: string; label: string }> = []
const clerkOptions: Array<{ value: string; label: string }> = []
const tagOptions = [
