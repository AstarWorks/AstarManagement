    ...
    <div class="performance-summary">
      ...
      <div class="metrics-grid">
        ...
        <div class="metric-card">
          ...
          <div class="metric-value">{{ metrics.performanceSummary.cacheHitRate.toFixed(1) }}%</div>
        </div>
        
        <div class="metric-card">
          <div class="metric-label">Avg Query Time</div>
          <div class="metric-value" :class="getTimeClass(metrics.performanceSummary.averageQueryTime)">
            {{ metrics.performanceSummary.averageQueryTime.toFixed(0) }}ms
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="timing-section">
      ...
      <div class="timing-stats">
        <div class="timing-stat">
          ...
          <span class="timing-value">{{ metrics.performanceSummary.p50QueryTime.toFixed(0) }}ms</span>
        </div>
        <div class="timing-stat">
          <span class="timing-label">P95:</span>
          <span class="timing-value" :class="getTimeClass(metrics.performanceSummary.p95QueryTime)">
            {{ metrics.performanceSummary.p95QueryTime.toFixed(0) }}ms
          </span>
        </div>
        <div class="timing-stat">
          <span class="timing-label">P99:</span>
          <span class="timing-value" :class="getTimeClass(metrics.performanceSummary.p99QueryTime)">
            {{ metrics.performanceSummary.p99QueryTime.toFixed(0) }}ms
          </span>
        </div>
      </div>
