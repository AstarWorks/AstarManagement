...
export function mountFormComponent(
  ...
  if (mockValidation) {
    ...
    vi.mocked(vi.doMock)('vee-validate', () => veeValidateMocks)
    vi.mocked(vi.doMock)('~/composables/form/useForm', () => formUtilityMocks.useFormState)
    vi.mocked(vi.doMock)('~/composables/form/useField', () => formUtilityMocks.useFormState)
    vi.mocked(vi.doMock)('~/composables/form/useFormState', () => formUtilityMocks.useFormState)
  }
