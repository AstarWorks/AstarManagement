...
export interface InvalidationPattern {
  queries: Array<(data?: any) => readonly any[]>
 ...
 */
export function getEntityQueryKeys(entityType: 'matter' | 'kanban' | 'activity', entityId?: string): readonly any[][] {
  switch (entityType) {
    case 'matter':
      return entityId
        ? [
