...
export const baseMatterSchema = z.object({
  title: requiredStringWithMax(255, 'Title must be less than 255 characters'),
  description: optionalStringWithMax(2000, 'Description must be less than 2000 characters'),
...
export const matterStatusTransitionSchema = z.object({
  ...
  reason: requiredStringWithMax(500, 'Reason must be less than 500 characters'),
...
export const documentAttachmentSchema = z.object({
  matterId: z.string().uuid('Matter ID is required'),
  title: requiredStringWithMax(255, 'Title must be less than 255 characters'),
  description: optionalStringWithMax(1000, 'Description must be less than 1000 characters'),
  category: z.enum([
    'PLEADING',
    'EVIDENCE',
    'CORRESPONDENCE',
...
export const timeEntrySchema = z.object({
  ...
  description: requiredStringWithMax(1000, 'Description must be less than 1000 characters'),
...
export const expenseEntrySchema = z.object({
  ...
  description: requiredStringWithMax(500, 'Description must be less than 500 characters'),
  category: z.enum([
    'COURT_FEES',
    'FILING_FEES',
    'TRAVEL',
  ...
  vendor: optionalStringWithMax(255, 'Vendor name must be less than 255 characters'),
  receiptNumber: optionalStringWithMax(100, 'Receipt number must be less than 100 characters'),
  isBillable: z.boolean().default(true),
...
export const calendarEventSchema = z.object({
  ...
  location: optionalStringWithMax(255, 'Location must be less than 255 characters'),
...
export const auditableMatterSchema = createMatterSchema.and(auditableSchema)
export const auditableClientSchema = clientSchema.and(auditableSchema)
export const auditableTimeEntrySchema = timeEntrySchema.and(auditableSchema)
export const auditableExpenseEntrySchema = expenseEntrySchema.and(auditableSchema)
